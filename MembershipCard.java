...
public class MembershipCard extends BillingSystem{
    ...
    public void deduct(){
        ...
        for(i=0;i<Product_price.size();i++) {
            discount.add((int) (Product_price.get(i) - (Product_price.get(i) * 0.2))) ;
        }
    ...
    public void save(){
        try {
            FileWriter myWriter = new FileWriter("MemberBillCopy.txt");
